...
<acme:list>
	<acme:list-column code="auditor.auditReport.list.label.ticker" path="ticker" width="20%"/>
	<acme:list-column code="auditor.auditReport.list.label.name" path="name" width="30%"/>
